...
class SubmitUserDataButton: UIButton, BorderedButtonProtocol {
    // MARK: Properties
    
    /* Constants for styling and configuration */
    var darkerFace = OTMColors.submitButtonDark
    var lighterFace = OTMColors.submitButtonLight
    var titleColor = OTMColors.submitButtonTitle
